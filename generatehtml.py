...
print("<p>Vinmonopolet har %d veganske viner fra %d produsenter. %d av disse vinene er i basisutvalget.</p>" % (total_product_count, len(all_companies), basisutvalg_count))
